...
// state. One POST /tally/action endpoint dispatches by `action`, mirroring
// MineskiX's routes/overlay.js `/mapselection/action` pattern. Editing is
// open to everyone (no password) — every connected scorekeeper shares one
// live tournament.
