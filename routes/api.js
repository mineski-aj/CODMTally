// routes/api.js — public read-only JSON surface for the Tally data.
//
// GET /api/roster   — whole-tournament roster derived from the Tally sheets
//                      (teams, players, kills, kill/placement/total score),
//                      plus ranked summaries (top kills by team/player, top
//                      placement points). Same computation the Roster page
//                      itself uses — see lib/tallyRoster.js.
